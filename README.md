...
[下载 21Vianet Office工具箱 v0.1.5](https://github.com/terry-sys/M365Tool/releases/tag/v0.1.5)

下载 `21VianetOfficeToolbox-portable-win-x64-v0.1.5.exe` 后直接运行即可；也可以下载同名 `.zip` 压缩包。

## 使用注意事项

- 本工具面向 21V 场景，需要完成 21V 账户验证。
